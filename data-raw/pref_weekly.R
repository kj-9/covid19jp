  ...
  tryCatch(
    {
      out <-
        ...
        transmute(
          ...
          accommodatedCases = readr::parse_number(V13),
          accommodatedCasesPhase = split_slash(V14, 1),
          accommodatedCasesMaxPhase = split_slash(V14, 2),
          accommodatedCasesCap = readr::parse_number(V15),
          accommodatedCasesCapPlanned = readr::parse_number(V17),
          accommodatedCasesUTE = readr::parse_number(V16) * 0.01,
